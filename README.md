...
<p align="left">
  <img src="https://skillicons.dev/icons?i=wireshark,linux,kali" alt="Networking Icons" />
</p>
...
## 🏗️ Core Learning Tracks

<table>
  <tr>
    <td width="50%">
      <h3>🌐 Networking — Strong Foundation</h3>
      <p><b>Track:</b> CCNA ✅</p>
      <ul>
        <li>OSI/TCP-IP, IPv4/IPv6, Subnetting.</li>
        <li>Routing, Switching, VLANs, ACL & NAT.</li>
      </ul>
    </td>
    <td width="50%">
      <h3>🔐 Cybersecurity — In Progress</h3>
      <p><b>Track:</b> CompTIA Security+</p>
      <ul>
        <li>Threats, Vulnerabilities & Risk Management.</li>
        <li>Cryptography, IAM & Security Architecture.</li>
      </ul>
    </td>
  </tr>
</table>
